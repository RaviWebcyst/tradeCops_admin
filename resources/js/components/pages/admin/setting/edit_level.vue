        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Update Level Chart</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item">
                        <router-link class="text-muted " :to="{name:'admin_home'}">Dashboard</router-link>
                      </li>
                      <li class="breadcrumb-item" aria-current="page">Update Level Chart</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-3">
          ...
          <div class="card w-100 position-relative overflow-hidden">
            <div class="px-4 py-3 border-bottom">
              <h5 class="card-title fw-semibold mb-0 lh-sm">Update Level Chart</h5>
            </div>
