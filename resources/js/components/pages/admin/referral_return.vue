        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Referral Returns</h4>
          ...
          <div class="card w-100 position-relative overflow-hidden">
            <div class="px-4 py-3 border-bottom">
              <h5 class="card-title fw-semibold mb-0 lh-sm">Referrals</h5>
            </div>
                ...
                <table class="table border text-nowrap customize-table mb-0 align-middle">
                  <thead class="text-dark fs-4">
                    <tr>
                      ...
                      <th><h6 class="fs-4 fw-semibold mb-0">Owner</h6></th>
                      <th><h6 class="fs-4 fw-semibold mb-0">Deposit Owner</h6></th>
                      <th><h6 class="fs-4 fw-semibold mb-0">Direct From</h6></th>
                      <th><h6 class="fs-4 fw-semibold mb-0">Deposit ID</h6></th>
                    </tr>
                  </thead>
                  <tbody>
                  </tbody>
